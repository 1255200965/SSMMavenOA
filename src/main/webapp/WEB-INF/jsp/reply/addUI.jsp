...
<div id="MainArea">
	...
	<form action="${pageContext.request.contextPath}/reply/add.action" style="margin: 0; padding: 0;">
				...
				<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
					...
					<tr>
						...
						<td class="InputAreaBg"><div class="InputContent">
							<input name="title" class="InputStyle" style="width:100%" value="回复：${topic.title }" readonly="readonly" /></div>
						</td>
					</tr>
					<tr height="240">
